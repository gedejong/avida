...
private:
  ...
  void ProcessTwoStepDelete(cAvidaContext& ctx, cTestCPU* testcpu, cCPUTestInfo& test_info, int cur_site, Genome& mod_genome);
  void ProcessInsertPointCombo(cAvidaContext& ctx, cTestCPU* testcpu, cCPUTestInfo& test_info, int cur_site, Genome& mod_genome);
  void ProcessInsertDeleteCombo(cAvidaContext& ctx, cTestCPU* testcpu, cCPUTestInfo& test_info, int cur_site, Genome& mod_genome);
  ...
  inline const Genome& Get1SAggregatePeakGenome() const { return m_ot.peak_genome; }
  ...
  inline const Genome& Get1SPointPeakGenome() const { return m_op.peak_genome; }
  ...
  inline const Genome& Get1SInsertPeakGenome() const { return m_oi.peak_genome; }
  ...
  inline const Genome& Get1SDeletePeakGenome() const { return m_od.peak_genome; }
  ...
  inline const Genome& Get2SAggregatePeakGenome() const { return m_tt.peak_genome; }
...
//  inline double Get2SAggregateComplexity() const { return m_tt.complexity; }
  ...
  inline const Genome& Get2SPointPeakGenome() const { return m_tp.peak_genome; }
  ...
  inline const Genome& Get2SInsertPeakGenome() const { return m_ti.peak_genome; }
  ...
  inline const Genome& Get2SDeletePeakGenome() const { return m_td.peak_genome; }
  ...
  inline const Genome& GetInsPntPeakGenome() const { return m_tip.peak_genome; }
  ...
  inline const Genome& GetInsDelPeakGenome() const { return m_tid.peak_genome; }
  ...
  inline const Genome& GetDelPntPeakGenome() const { return m_tdp.peak_genome; }

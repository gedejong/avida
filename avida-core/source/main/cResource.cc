...
cResource::cResource(const cString & _name, int _id)
  ...
  , inflowX1( )
  , inflowX2(cResource::NONE)
  , inflowY1(cResource::NONE)
  , inflowY2(cResource::NONE)
  , outflowX1(cResource::NONE)
  , outflowX2(cResource::NONE)
  , outflowY1(cResource::NONE)
  , outflowY2(cResource::NONE)
  , xdiffuse(1.0)
  , xgravity(0.0)
  , ydiffuse(1.0)
  , ygravity(0.0)
...
void cResource::SetCellIdList(AvidaArray<int>& id_list) {

...
void cContextPhenotype::AddTaskCounts(int number_tasks, const AvidaArray<int>& cur_task_count)
{
...
void cContextPhenotype::AddReactionCounts(int number_reactions, const AvidaArray<int>& cur_reaction_count)
{
    // Step 1: Resize m_cur_thread_task_count array if necessary.  This is necessary
    // since CThreadPhenotype object does not have any information apriori about m_world.
